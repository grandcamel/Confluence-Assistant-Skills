...
from confluence_assistant_skills_lib import (
    get_confluence_client, handle_errors, validate_cql, validate_limit,
    print_success, format_search_results, format_json,
)
...
Examples:
  ...
  python cql_search.py "label = 'approved'" --limit 50 --show-excerpts
    ...
    parser.add_argument('--show-excerpts', action='store_true',
                        help='Show content excerpts')
    parser.add_argument('--show-labels', action='store_true',
                        help='Show content labels')
    parser.add_argument('--show-ancestors', action='store_true',
                        help='Show ancestor pages')
