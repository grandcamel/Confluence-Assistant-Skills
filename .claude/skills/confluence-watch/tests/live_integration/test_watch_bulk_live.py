...
Usage:
    pytest test_watch_bulk_live.py --profile development -v
"""
...
class TestWatchBulkLive:
        ...
        for page in test_pages:
            try:
                confluence_client.post(
                    f"/rest/api/user/watch/content/{page['id']}",
                    json_data={}
                )
            except Exception:
    ...
    def test_check_watch_status_multiple(self, confluence_client, test_pages, current_user):
