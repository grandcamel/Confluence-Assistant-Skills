...
class TestListProperties:
    ...
    def test_list_properties_with_pagination(self, mock_client):
        ...
        page1 = {
            'results': [
                {'id': 'p1', 'key': 'prop1', 'value': 'val1'}
            ],
            '_links': {
                'next': '/rest/api/content/12345/property?start=1&limit=1'
            }
        }

        page2 = {
            'results': [
                {'id': 'p2', 'key': 'prop2', 'value': 'val2'}
            ],
            '_links': {}
        }
            ...
            'results': [
                {
                    ...
                    'version': {'number': 1, 'when': '2024-01-01', 'by': 'user@example.com'}
                }
            ],
            '_links': {}
        }
