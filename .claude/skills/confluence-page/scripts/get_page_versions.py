...
from formatters import print_success, format_version, format_json, format_table
...
Examples:
  ...
  python get_page_versions.py 12345 --detailed --output json
    ...
    parser.add_argument('--detailed', action='store_true',
                        help='Show full version details')
            ...
            if args.detailed:
                ...
                for v in versions:
                    data.append({
                        ...
                        'by': v.get('by', {}).get('displayName', v.get('by', {}).get('username', 'Unknown')),
