...
#   ./scripts/run_single_test.sh confluence-search test_cql_search.py::TestCqlSearch
#   ./scripts/run_single_test.sh confluence-page test_create_page.py::TestCreatePage::test_basic_page
#   ./scripts/run_single_test.sh confluence-search -k "test_validate"
#
# Examples:
...
#   ./scripts/run_single_test.sh confluence-page test_create_page.py::TestCreatePage
#
#   # Run a specific test method
#   ./scripts/run_single_test.sh confluence-page test_create_page.py::TestCreatePage::test_basic_page
#
#   # Run tests matching a keyword
#   ./scripts/run_single_test.sh confluence-search -k "validate"
#
#   # Run with verbose output and show locals
#   ./scripts/run_single_test.sh confluence-space test_list_spaces.py -v --tb=long
#
#   # Re-run only failed tests from last run
#   ./scripts/run_single_test.sh confluence-page --lf
#
#   # Run tests and stop on first failure
#   ./scripts/run_single_test.sh confluence-page test_create_page.py -x
...
SKILLS_ROOT="$PROJECT_ROOT/.claude-plugin/.claude/skills"
...
show_help() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 confluence-page test_create_page.py"
    echo "  $0 confluence-page test_create_page.py::TestCreatePage"
    echo "  $0 confluence-search -k 'validate'"
    echo "  $0 confluence-space test_list_spaces.py -v --tb=long"
    echo "  $0 confluence-page --lf"
}
