...
class TestGetPageRestrictions:
    ...
    def test_get_page_restrictions_unrestricted(self, mock_client):
        ...
        unrestricted = {
            "read": {"operation": "read", "restrictions": {"user": {"results": [], "size": 0}, "group": {"results": [], "size": 0}}},
            "update": {"operation": "update", "restrictions": {"user": {"results": [], "size": 0}, "group": {"results": [], "size": 0}}}
        }
...
class TestRestrictionFormatting:
    ...
    def test_format_group_restriction(self, sample_page_restrictions):
        ...
        read_groups = sample_page_restrictions['read']['restrictions']['group']['results']
