  ...
  python get_template.py tmpl-123 --output json
    ...
    if args.output == 'json':
        ...
        if args.blueprint:
            ...
            print(f"ID: {result.get('blueprintId', result.get('contentBlueprintId', 'N/A'))}")
    ...
    print_success(f"Retrieved {'blueprint' if args.blueprint else 'template'} {template_id}")
